...
app.get('/about', (req, res) => {
  ...
  app.get('/moremarker', (req, res) => {
    res.sendFile('./more_markers.html', {root: __dirname});
  });
  ...
  app.get('/satelit', (req, res) => {
    res.sendFile('./satelit.html', {root: __dirname});
  });
  ...
  app.post("/process", (req, res) => {
    ...
    const sql = 'INSERT INTO db_rs (nama_rs, latlng_rs, gambar_rs, alamat_rs) VALUES (?, ?, ?, ?)';
